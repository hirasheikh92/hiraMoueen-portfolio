  ...
  return (
    ...
    >
      ...
      <div className=' w-full mdl:w-[900px] text-base text-textDark font-medium flex mt-5 flex-col gap-4'>
        <p>
          Hi there! My name is Hira and I am a frontend developer with 2 years
          of experience in creating visually stunning and user-friendly
          websites. I have a passion for crafting beautiful, intuitive user
